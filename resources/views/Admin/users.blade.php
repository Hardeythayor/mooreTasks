...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header"><h5 class="font-weight-bold">{{ __('All Users') }}</h5></div>
                ...
                <div class="card-body">
                    ...
                    <form class="mb-4 mt-3">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="all" name="status" value="" checked>
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="pending" name="status" value="pending">
                        ...
                        <button id="filter" type="button" class="btn btn-primary btn-sm px-4">Filter</button>
                    </form>
